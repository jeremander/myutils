...
class Tree(object):
    ...
    def draw(self, labels = None, filename = None, font_size = 12, node_size = 500):
        ...
        nx.draw_networkx(self.nx_tree, pos, labels = labels, font_size = font_size, node_size = node_size, node_color = 'white', edge_color = 'blue', linewidths = 0, arrows = False)
