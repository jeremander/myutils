...
def rstyle(ax):
    ...
    ax.xaxis.set_minor_locator(MultipleLocator( (ax.xaxis.get_ticklocs()[1]-ax.xaxis.get_ticklocs()[0]) / 2.0 ))
    ax.yaxis.set_minor_locator(MultipleLocator( (ax.yaxis.get_ticklocs()[1]-ax.yaxis.get_ticklocs()[0]) / 2.0 ))
